...
if (cityList.size() != 24) {
String filePath =
getClass().getClassLoader().getResource("data/CityCountyData.json").getPath();
ObjectMapper objectMapper3 = new ObjectMapper();

List<CityDto> cityDtoList = objectMapper3.readValue(new File(filePath), new
TypeReference<List<CityDto>>() {
});
